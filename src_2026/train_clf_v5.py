"""
Training script v5 — ResNet1D cu normalizare globala pe beat features.

Diferente fata de v3:
  - Normalizare globala (mean/std din train set, nu per-fereastra)
    → clasa 0 (stationary) nu mai apare ca zerouri; distanta relativa
      intre clase este pastrata indiferent de variatia per-fisier
  - Dropout=0.3 dupa pooling → regularizare mai puternica
  - Acelasi split fisier-nivel si aceleasi ponderi de clasa (refolosim cache)
"""
...
MODEL_SAVE_PATH  = '../models/movement_clf_v5.pth'
HISTORY_PATH     = '../models/movement_clf_v5_history.json'
WEIGHTS_PATH     = '../models/movement_clf_v3_weights.json'   # refolosim cache v3
NORM_STATS_PATH  = '../models/movement_clf_v5_norm_stats.npz'
LOG_DIR          = '../logs'
