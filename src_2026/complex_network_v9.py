...
# ---------------------------------------------------------------------------
# ComplexUNet v9 — identic cu v7 dar cu soft mask la output
# ---------------------------------------------------------------------------
class ComplexUNetV9(nn.Module):
    def __init__(self, dimension, in_channels=6):
        ...
        # Output head → produce logits pentru masca
    ...
    def forward(self, x):
        x_in = x                     # salvam mixture_spec original
        ...
        # Soft mask: sigmoid(logits) ∈ [0, 1] aplicata pe input
