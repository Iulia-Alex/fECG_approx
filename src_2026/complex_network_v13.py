...
class ComplexUNetV13(nn.Module):
    def __init__(self, dimension, in_channels=6):
        ...
        # Output head → logits pentru mască
    ...
    def forward(self, x):
        x_in = x   # inputul original, pentru mască la final
        ...
        x = x / scale   # rețeaua vede inputuri normalizate
        ...
        # Mască soft ∈ [0,1] aplicată pe inputul ORIGINAL (la scală reală)
