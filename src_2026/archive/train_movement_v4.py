"""
Training script v4 — fine-tuning v1 with soft amplitude-weighted loss.

Architecture: identical to v1 (ComplexUNet, 0.59M, 128×400, 1000 Hz)
Warm start  : loads v1 best checkpoint, fine-tunes with lower LR
...
PRETRAIN_PATH    = '../models/movement_CUNet_128x400_composed.pth'   # v1 best
MODEL_SAVE_PATH  = '../models/movement_CUNet_128x400_ampw.pth'
HISTORY_PATH     = '../models/movement_CUNet_128x400_ampw_history.json'
LOG_DIR          = '../logs'

LEARNING_RATE    = 1e-5       # lower LR: fine-tuning, not training from scratch
WEIGHT_DECAY     = 1e-5
BATCH_SIZE       = 32
MAX_EPOCHS       = 200
PATIENCE         = 20         # more patience: fine-tuning converges slower
VAL_SPLIT        = 0.15
NUM_WORKERS      = 2
PRINT_EVERY      = 20
SEED             = 42
...
def main():
    ...
    # Warm start from v1
    print(f'Loading v1 checkpoint: {PRETRAIN_PATH}')
    ...
    print(f'Architecture     : ComplexUNet v1 (6ch, 128x400, 0.59M) — warm start')
