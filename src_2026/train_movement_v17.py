...
def att_loss(alpha_ag1: torch.Tensor, att_target_128: torch.Tensor) -> torch.Tensor:
    ...
    # Downsample masca 128 → 64 cu avg_pool (pastram soft values)
...
def main():
    ...
    # ── Forward hook pentru alpha AG1 ──────────────────────────────────────
    # Inregistrat o singura data — captureaza output-ul sigmoid al AG1.psi
    alphas_store: dict = {}
