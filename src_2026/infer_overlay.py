"""
Overlay plot — predicted fECG vs ground truth on the same axes.
Runs on CPU, does NOT affect training.
"""
...
OUT_PATH = f'../plots_2026/inference_overlay_ep{EPOCH}.png'
print(f'Model loaded from {MODEL_PATH}  (best epoch: {EPOCH})')

# ---------------------------------------------------------------------------
# Load & normalise signals
# ---------------------------------------------------------------------------
...
fig.suptitle(
    f'fECG Extraction — Predicted vs Ground Truth  (epoch {EPOCH})\n'
