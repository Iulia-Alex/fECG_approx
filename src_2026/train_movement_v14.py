"""
Training script v14 — ComplexUNetV14 (arhitectura mărită 32→256) + SignalMSE.

Fidel paper-ului (arxiv:2506.22457):
  - Arhitectura: 6→32→64→128→256, bottleneck 512, instance norm, mask, Diag, RoAct
  - Dataset: FS=500Hz, STFT 128×128 (n_fft=256, hop=15, win=100)
  - Loss: SignalMSE only (MSE temporal după iSTFT @ 500Hz)
"""
...
LEARNING_RATE   = 1e-4
WEIGHT_DECAY    = 1e-5
BATCH_SIZE      = 8     # mai mic față de v9 (arhitectura ~4× mai mare)
MAX_EPOCHS      = 300
PATIENCE        = 20
VAL_SPLIT       = 0.15
NUM_WORKERS     = 2
